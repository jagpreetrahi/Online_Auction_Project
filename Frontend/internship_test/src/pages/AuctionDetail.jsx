         ...
         <div className=" container mt-5 mb-5">
            <div className="row g-3 ">
               <div className=" col-12  d-flex justify-content-between">
                  ...
                  <div className="mt-4 d-flex me-5" style={{width : "520px" , height : '300px'}}>
                  ...
                  <div className="w-75 d-flex flex-column mx-1">
                        ...
                        <div className="w-75 shadow-sm  mt-4  d-flex flex-column" style={{height : "200px"  , maxWidth : "500px" , borderRadius :  "15px"}}>
                              ...
                              <div className="d-flex flex-row justify-content-center">
                                 <button  className="mx-4"style={{border : 'none'}}  onClick={increaseValue}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                 ...
                                 <button className="me-4 w-2 h-2" style={{border : 'none'}}  onClick={decreaseValue}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dash" viewBox="0 0 16 16">
